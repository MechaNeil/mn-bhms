...
new class extends Component {
    ...
    public function assistants(): LengthAwarePaginator
    {
        return Assistant::query()
            ...
            ->with(['property'])
            ->when($this->search, fn(Builder $q) => $q->where('users.first_name', 'like', "%$this->search%")
...
<div>
    ...
    <x-header title="Assistants" separator progress-indicator>
        ...
        <x-slot:actions>
            ...
            <x-button class="btn normal-case btn-primary" label="Create" link="/create-assistant" responsive
